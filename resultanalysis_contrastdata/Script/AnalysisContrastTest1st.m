function AnalysisContrastTest1st()
...
%% フィッティング
dataCon = FitDataCon1st(dataCon);
% h = figure;
% Copy_of_MakePlot(dataCon,h)

%% データ保存
save(['test1_' dataCon.subjectID '_' dataCon.id '_' dataCon.date '.mat' ], 'dataCon');